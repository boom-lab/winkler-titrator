...
"border-color: rgb(0, 116, 0);")
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(0, -10, 1071, 221))
        ...
        self.comboBox_meter = QtWidgets.QComboBox(self.horizontalLayoutWidget_2)
        ...
        self.comboBox_standard = QtWidgets.QComboBox(self.horizontalLayoutWidget_2)
        ...
        self.pushButton_reload = QtWidgets.QPushButton(self.horizontalLayoutWidget_2)
        self.pushButton_reload.setObjectName("pushButton_reload")
        self.verticalLayout_5.addWidget(self.pushButton_reload)
        self.horizontalLayout_2.addLayout(self.verticalLayout_5)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem3)
        self.pushButton_flask = QtWidgets.QPushButton(self.horizontalLayoutWidget_2)
        ...
        self.verticalLayout_3.addWidget(self.comboBox_flasks, 0, QtCore.Qt.AlignHCenter)
        ...
        self.verticalLayout_3.addWidget(self.pushButton_titrate, 0, QtCore.Qt.AlignHCenter)
        self.horizontalLayout_lower.addLayout(self.verticalLayout_3)
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_lower.addItem(spacerItem6)
        ...
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.tab_Standard)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(240, 0, 581, 252))
        ...
        self.verticalLayout_9.addWidget(self.spinBox_standard)
        self.pushButton_standard = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        self.pushButton_standard.setMinimumSize(QtCore.QSize(0, 100))
        self.pushButton_standard.setObjectName("pushButton_standard")
        self.verticalLayout_9.addWidget(self.pushButton_standard)
        self.lcdNumber_standard = QtWidgets.QLCDNumber(self.horizontalLayoutWidget_3)
        self.lcdNumber_standard.setAutoFillBackground(False)
        self.lcdNumber_standard.setSmallDecimalPoint(False)
        self.lcdNumber_standard.setProperty("value", 10000.0)
        self.lcdNumber_standard.setProperty("intValue", 10000)
        self.lcdNumber_standard.setObjectName("lcdNumber_standard")
        self.verticalLayout_9.addWidget(self.lcdNumber_standard)
        self.horizontalLayout_3.addLayout(self.verticalLayout_9)
        self.tabs.addTab(self.tab_Standard, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Select flask and titrate"))
        ...
        self.tabs.setTabText(self.tabs.indexOf(self.tab_Sample), _translate("MainWindow", "Sample"))
        self.label_8.setText(_translate("MainWindow", "Volume of KIO3 to dispense (uL)"))
        self.pushButton_standard.setText(_translate("MainWindow", "Dispense Standard"))
        self.tabs.setTabText(self.tabs.indexOf(self.tab_Standard), _translate("MainWindow", "Standard"))
