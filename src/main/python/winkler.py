...
"border-color: rgb(0, 116, 0);")
        ...
        self.checkBox_debug = QtWidgets.QCheckBox(parent=self.horizontalGroupBox_2)
        self.checkBox_debug.setObjectName("checkBox_debug")
        self.verticalLayout_4.addWidget(self.checkBox_debug)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_debug.setText(_translate("MainWindow", "Debug Mode (No Hardware Required)"))
        self.checkBox_debug.setToolTip(_translate("MainWindow", "Enable debug mode to run without physical devices"))
